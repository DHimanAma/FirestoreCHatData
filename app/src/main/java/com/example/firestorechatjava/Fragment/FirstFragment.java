...
//        super.onResume();
            ...
            String video_url = "android.resource://" + getActivity().getPackageName() + "/" + R.raw.anim1;
...
//                    OnBoarding.pager.setCurrentItem(1);
//                }
//            });
        } else {
...
//        else {
//
//            Toast.makeText(videoplayer.this, "No Locale found for this device!!", Toast.LENGTH_SHORT).show();
//        }
