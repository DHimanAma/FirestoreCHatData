...
public class Thirdfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_thirdfragment, container, false);
...
//        super.onResume();
            ...
            String video_url = "android.resource://" + getActivity().getPackageName() + "/" + R.raw.anim3;
...
//                    OnBoarding.pager.setCurrentItem(0);
//                }
//            });
        } else {
